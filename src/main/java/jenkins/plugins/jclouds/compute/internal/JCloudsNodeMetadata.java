...
@SuppressFBWarnings(
        ...
        justification = "We really don't want to compare the nonce")
public class JCloudsNodeMetadata extends NodeMetadataImpl implements NodeMetadata {
    ...
    public JCloudsNodeMetadata(
            ...
            @Nullable Hardware hardware,
            @Nullable String imageId,
            @Nullable OperatingSystem os,
            Status status,
            @Nullable String backendStatus,
            int loginPort,
    ...
    public static JCloudsNodeMetadata fromNodeMetadata(final NodeMetadata nmd, final String nonce) {
        return new JCloudsNodeMetadata(
                nmd.getProviderId(),
                nmd.getName(),
                nmd.getId(),
                nmd.getLocation(),
                ...
                nmd.getHardware(),
                nmd.getImageId(),
                nmd.getOperatingSystem(),
                nmd.getStatus(),
                nmd.getBackendStatus(),
                nmd.getLoginPort(),
                nmd.getPublicAddresses(),
                nmd.getPrivateAddresses(),
                nmd.getCredentials(),
                nmd.getHostname(),
                nonce);
    }
