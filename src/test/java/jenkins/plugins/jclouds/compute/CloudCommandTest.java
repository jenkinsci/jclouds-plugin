...
class CloudCommandTest {
    ...
    void testCopyPermission(JenkinsRule j) throws Exception {
        setUp(j);
        CLICommandInvoker.Result res = new CLICommandInvoker(j, "jclouds-copy-cloud")
    ...
    void testCopyFoo(JenkinsRule j) throws Exception {
        ...
        JCloudsCloud cloud = new JCloudsCloud("foo", "aws-ec2", "",
    ...
    void testCreateCloud(JenkinsRule j) throws Exception {
        ...
        String xml = new String(getClass().getResourceAsStream("create-cloud-cmd.xml").readAllBytes(),
                StandardCharsets.UTF_8);
        xml = xml.replace("_ID1_", cid1).replace("_ID2_", cid2).replace("_HASH1_", hash1).replace("_HASH2_", hash2);
        InputStream stdin = new ByteArrayInputStream(xml.getBytes(StandardCharsets.UTF_8));
        ...
        res = new CLICommandInvoker(j, "jclouds-create-cloud")
                .withStdin(stdin).invokeWithArgs("foo");
        assertThat(res, failedWith(4));
    ...
    void testCreateCloudNoHash(JenkinsRule j) throws Exception {
        ...
        String xml = new String(getClass().getResourceAsStream("create-cloud-cmd-nohash.xml").readAllBytes(),
                StandardCharsets.UTF_8);
    ...
    void testUpdateCloudNoOptions(JenkinsRule j) throws Exception {
        ...
        String xml = new String(getClass().getResourceAsStream("update-cloud-cmd.xml").readAllBytes(),
                StandardCharsets.UTF_8);
        xml = xml.replace("_ID1_", cid1).replace("_ID2_", cid2).replace("_HASH1_", hash1).replace("_HASH2_", hash2);
        InputStream stdin = new ByteArrayInputStream(xml.getBytes(StandardCharsets.UTF_8));
    ...
    void testUpdateCloudDeleteTemplates(JenkinsRule j) throws Exception {
        ...
        CLICommandInvoker.Result res = new CLICommandInvoker(j, "jclouds-update-cloud")
                .withStdin(stdin).invokeWithArgs("foo", "--delete-templates");
        assertThat(res, succeededSilently());
    ...
    void testUpdateCloudKeepTemplates(JenkinsRule j) throws Exception {
        ...
        CLICommandInvoker.Result res = new CLICommandInvoker(j, "jclouds-update-cloud")
                .withStdin(stdin).invokeWithArgs("foo", "--keep-templates");
        assertThat(res, succeededSilently());
    ...
    void testUpdateCloudRenameToExisting(JenkinsRule j) throws Exception {
        ...
        CLICommandInvoker.Result res = new CLICommandInvoker(j, "jclouds-update-cloud")
                .withStdin(stdin).invokeWithArgs("foo", "--keep-templates");
        assertThat(res, failedWith(4));
        assertThat(res.stderr(), containsString("Unable to rename cloud profile: A cloud with the name graustack already exists"));
    }
    ...
    void testUpdateCloudVerbose(JenkinsRule j) throws Exception {
        ...
        CLICommandInvoker.Result res = new CLICommandInvoker(j, "jclouds-update-cloud")
                .withStdin(stdin).invokeWithArgs("foo", "--keep-templates", "--verbose");
        assertThat(res, succeeded());
